...
SELECT_MB_RECORDINGS_QUERY = '''
    SELECT DISTINCT lower(musicbrainz.musicbrainz_unaccent(artist_credit_name::TEXT)) as artist_credit_name, artist_credit_id,
                    lower(musicbrainz.musicbrainz_unaccent(recording_name::TEXT)) AS recording_name, recording_id,
                    lower(musicbrainz.musicbrainz_unaccent(release_name::TEXT)) AS release_name, release_id
